...
%dal primo anno faccio la media oraria di ogni domenica
for i = 1:24
...
plot(giorni, trend, 'k');
hold on
giorni = linspace(105,156,n/2);
trend_previsto = trend(104*24+1:156*24,1);
SupremiConsumi = consumiDetrendModel + trend_previsto; 
plot(giorni, SupremiConsumi);
